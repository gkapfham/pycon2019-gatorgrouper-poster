...
\betterposter{
  ...
  \maincolumn{
    ...
    Suitable for classroom adoption, \textbf{GatorGrouper} uses data to
    automatically form effective teams
    %
    \vfill
    ...
    {\fontsize{180}{80}\selectfont
      ...
      \begin{center}
        ...
        \faGithubAlt{} \fontsize{80}{60}\selectfont GatorEducator/GatorGrouper
